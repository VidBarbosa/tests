...
async function seed() {
    ...
    const rateRepo = data_source_1.AppDataSource.getRepository(UserProjectRate_1.UserProjectRate);
    ...
    await data_source_1.AppDataSource.query('TRUNCATE TABLE "tasks", "user_project_rates", "users", "projects" RESTART IDENTITY CASCADE');
